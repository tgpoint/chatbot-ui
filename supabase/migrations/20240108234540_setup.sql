...
AS $$
DECLARE
  project_url TEXT := 'https://jiqacnimujfkkmaebgzr.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImppcWFjbmltdWpma2ttYWViZ3pyIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTczOTU4MTM4NSwiZXhwIjoyMDU1MTU3Mzg1fQ.Jr7va3AIqP_4kAHYYJecLeHQ878JBRDDovNt-i5TOcI'; -- full access needed for http request to storage
